...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 18));var _login2 = _interopRequireDefault(__webpack_require__(/*! @/utils/login */ 21));
var _config = _interopRequireDefault(__webpack_require__(/*! @/constants/config */ 23));
...

{
  ...
  actions: {
    login: function () {var _login = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(context) {var USER_INFO;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                USER_INFO = uni.getStorageSync('USER_INFO');if (!(
                USER_INFO && !_config.default.userInfo.expire)) {_context.next = 6;break;}
                _config.default.userInfo = USER_INFO;
                context.commit('setIsAdmin', USER_INFO.isAdmin);
                context.commit('setShareLikes', USER_INFO.shareLikes);return _context.abrupt("return");case 6:

                ;
                _login2.default.login().then(function (res) {
                  if (res.status === 0) {var
                    userInfo = res.userInfo;
                    _config.default.userInfo = _objectSpread({}, userInfo, { expire: false });
                    uni.setStorageSync('USER_INFO', userInfo);
                    context.commit('setIsAdmin', userInfo.isAdmin);
                    context.commit('setShareLikes', userInfo.shareLikes);
                  }
                });case 8:case "end":return _context.stop();}}}, _callee);}));function login(_x) {return _login.apply(this, arguments);}return login;}() } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
var request = /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref) {var name, data, needLogin, token, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:name = _ref.name, data = _ref.data, needLogin = _ref.needLogin;if (!(
            needLogin === 1 || needLogin === 2)) {_context.next = 9;break;}
            token = _config.default.userInfo.token;if (!
            token) {_context.next = 7;break;}
            data.token = token;_context.next = 9;break;case 7:if (!(

            needLogin === 1)) {_context.next = 9;break;}return _context.abrupt("return",
            uni.showModal({
              title: '还没登录呢',
              content: '还没登录呢',
              cancelText: '就不',
            ...
            res.result.status !== 0 && res.result.msg.indexOf('token'))) {_context.next = 17;break;}
            _config.default.userInfo.expire = true;return _context.abrupt("return",
            uni.showModal({
              title: '登录态失效',
              content: '登录态失效',
              cancelText: '就不',
            ...
            res.result);case 20:_context.prev = 20;_context.t0 = _context["catch"](9);return _context.abrupt("return",

            {
              status: 500,
              msg: 'Network error' });case 23:case "end":return _context.stop();}}}, _callee, null, [[9, 20]]);}));return function request(_x) {return _ref2.apply(this, arguments);};}();var _default =
...
/* 25 */
/*!************************************************************************!*\
  !*** E:/develop/小程序/cozyben-weapp/js_sdk/functionTool/functionTool.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  throttle: function throttle(fn) {var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
    var last = 0;
    return function () {
      var curr = +new Date();
      if (curr - last > delay) {
